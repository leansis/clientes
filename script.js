        ...
        enrutadorGrid.innerHTML = ENRUTADOR_APP.screens.map((screen) => `
            <div class="screenshot-container">
                ...
                <div style="display:flex; flex-direction:row; background:white;">
                    <a href="manuales/necesidades.xlsx"><img src="${screen.image1}" class="img-enlace" alt="${screen.title}" class="screenshot-img" onerror="this.src='https://placehold.co/1200x800/f8f9fa/333333?text=${encodeURIComponent(screen.title)}'"></a>
                    <a href="manuales/flota.xlsx"><img src="${screen.image2}" class="img-enlace" alt="${screen.title}" class="screenshot-img" onerror="this.src='https://placehold.co/1200x800/f8f9fa/333333?text=${encodeURIComponent(screen.title)}'"></a>
                    <a href="manuales/restricciones.xlsx"><img src="${screen.image3}" class="img-enlace" alt="${screen.title}" class="screenshot-img" onerror="this.src='https://placehold.co/1200x800/f8f9fa/333333?text=${encodeURIComponent(screen.title)}'"></a>
                </div>
            </div>
        `).join('');
    }
